"""
Django settings for tst_squashing_1 project.
...
ROOT_URLCONF = 'tst_squashing_1.urls'
...
WSGI_APPLICATION = 'tst_squashing_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TST squashing Support <support@tst-squashing-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_squashing_1 API",
    "DESCRIPTION": "API documentation for tst_squashing_1 App",
    "VERSION": "v1",
}
